...
class URulesAgent;
class UNarratorAgent;
class UWorldStateAgent;
struct FRulesUpdate;
...
public:
	...
	/** Send player input and rules result to World State Agent for processing */
...
private:
	...
	/** Handle the result of the WorldStateAgent processing AI's response */
	UFUNCTION()
	void HandleWorldStateResult(const FWorldReaction& WorldReaction, const FString& RulesResultJson, const FString& WorldReactionJson, const FString& PlayerInput);
